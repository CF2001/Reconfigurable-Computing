...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../HammingCode.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../HammingCode.gen/sources_1/bd/mb_design/ipshared/7698" \
       +incdir+"../../../../HammingCode.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../HammingCode.gen/sources_1/bd/mb_design/ipshared/7698" \
       -input simulate.do
}
